...
<div class="container">
    <main class="main-content">
        ...
        <div class="grid-container">
            ...
            %>
            <div class="grid-item registro"><%= i + 1 %>
            </div>
            <div class="grid-item username"><%= lista.get(i).getNome() %>
            </div>
            <div class="grid-item">
    ...
    <div id="popupIDSituacaoTrabalhista" style="display: none;">
        <div class="popup">
            <form action="alterarSituacaoTrabalhista" id="editarSituacaoTrabalhista" class="registrar" method="post">
                <div class="bloco-titulo">
