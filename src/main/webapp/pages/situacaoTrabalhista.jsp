...
<head>
    ...
    <title>Sitiuação trabalhista</title>
...
<aside class="sidebar">
    ...
    <nav>
        <ul>
            ...
            <li  class="selecionado"><a href="listarSituacao_Trabalhistas">Situação Trabalhista</a></li>
...
<div class="container">
    <main class="main-content">
        <header class="titulo">
            ...
            <button class="inserir-situacao">Inserir Status</button>
        </header>
        ...
        <div class="grid-container">
            ...
            <div class="grid-item">Concluído</div>
            <div class="grid-item">
                <button class="action view"><img src="img/olho.png" alt=""></button>
                <button class="action edit"><img src="img/lapis.png" alt=""></button>
                <button class="action delete"><img src="img/lixo.png" alt=""></button>
    ...
    <!-- Popup para Inserir Situação Trabalhista -->
