...
<aside class="sidebar">
    ...
    <nav>
        <ul>
            ...
            <li  class="selecionado"><a href="listarPermissao_Vaga">Permissão Vaga</a></li>
...
<div class="container">
    <main class="main-content">
        ...
        <div id="filter-bar" style="display: none;">
            <form action="#" method="GET">
                <select name="filter-field">
                    ...
                    <option value="id_vaga-filtro">ID Vaga</option>
                </select>
        ...
        <div class="grid-container">
            ...
            <div class="grid-header id_vaga">ID Vaga</div>
