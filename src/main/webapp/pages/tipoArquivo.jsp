...
<aside class="sidebar">
    ...
    <nav>
        <ul>
            <li><a href="#"><img src="img/house.png" alt="Home icon">Home</a></li>
...
<div class="container">
    <main class="main-content">
        <header class="titulo">
            ...
            <button class="inserir-adm">Inserir Tipo de Arquivo</button>
        </header>
        ...
        <div id="filtrar-bar" style="display: none;">
            <form action="#">
                <select name="filter-field">
                    ...
                    <option value="Registro-filtro">UUID</option>
        ...
        <div class="grid-container">
            ...
            <div class="grid-header acoes">Nome</div>
